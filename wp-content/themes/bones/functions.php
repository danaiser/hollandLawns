...
function google_fonts(){
 echo '<link href="http://fonts.googleapis.com/css?family=Playfair%20Display|Arimo" rel="stylesheet" type="text/css">' . "\n";
}
...
//create own text widget
class My_Widget extends WP_Widget {
	function My_Widget() {
		parent::WP_Widget(false, 'Our Widget');
	}
...
//explains less information on the front end with login issues
