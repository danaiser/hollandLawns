...
AgmMapHandler = function (selector, data, allowInsertion) {
	...
	var init = function () {
		...
		$('body').on('click', '.agm_mh_marker_item', centerToMarker);
		$('body').on('click', '.agm_mh_marker_delete_item', removeMarker);
		$('body').on('click', '.agm_mh_info_icon_switch', showMarkerIconsList);
		$('body').on("change", '.agm_mh_info_title', updateMarkerTitle);
		$('body').on('change', '.agm_mh_info_body', updateMarkerBody);
	};
	...
	var destroy = function () {
		$container.empty();
		$('body').off('click', '.agm_mh_marker_item');
		$('body').off('click', '.agm_mh_marker_delete_item');
		$('body').off('click', '.agm_mh_info_icon_switch');
		$('body').off("change", '.agm_mh_info_title');
		$('body').off('change', '.agm_mh_info_body');
	};
