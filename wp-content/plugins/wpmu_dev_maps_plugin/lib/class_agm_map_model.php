...
class AgmMapModel {
	...
	function get_map_defaults () {
		...
		$ret['directions_snapping'] = isset($defaults['directions_snapping']) ? (int)$defaults['directions_snapping'] : 1;
		return $ret;
	}
	...
	function prepare_map ($map) {
		...
		$defaults = $this->get_map_defaults();//apply_filters('agm_google_maps-options', get_option('agm_google_maps'));
